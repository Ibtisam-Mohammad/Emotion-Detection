...
def detect(weights,source='inference/images',img_size=640,conf_thres=0.25,iou_thres=0.45,\
    device='',view_img=True,save_txt=True,save_conf=True,save_crop=True,\
        nosave=True, agnostic_nms=True, augment=True, update=True, project='runs/detect', name='exp',\
        exist_ok=True, no_trace=True, save_img=False, classes=[0]):
